  ...
  return (
    <div className="absolute inset-0 flex flex-col pt-[52px] text-foreground"
      ...
      <div className="relative z-10 flex items-center justify-between px-6">
        <span className="neko-text-card-title text-[oklch(0.5_0.05_300)]">×</span>
        <span className="neko-text-tiny text-[oklch(0.55_0.06_300)]">SOUL CARD</span>
        <span className="neko-text-tiny text-[oklch(0.6_0.1_320)]">分享</span>
      </div>
      ...
      <div className="relative z-10 mx-6 mt-6 overflow-hidden rounded-[36px] bg-white shadow-[0_30px_60px_-25px_oklch(0.78_0.11_305/0.45)]">
        ...
        <div className="relative p-6">
          <div className="flex items-center justify-between neko-text-tiny text-[oklch(0.55_0.08_320)]">
            <span>喵一下</span>
          ...
          <div className="mt-5 text-center">
            <div className="neko-text-badge text-[oklch(0.6_0.1_320)]">高冷观察者 · INTJ-A</div>
            <div className="mt-2 neko-text-page-title text-foreground">糯 米 团</div>
            <div className="mt-1 neko-text-tiny text-[oklch(0.58_0.04_300)]">A QUIET LITTLE SOUL</div>
          </div>

          {/* tags */}
          <div className="mt-4 flex flex-wrap justify-center gap-1.5">
            {["安静", "傲娇", "撒娇高手", "夜行性"].map((t, i) => (
              <span key={t} className="rounded-full px-3 py-1 neko-text-badge"
          ...
          <div className="mt-5 grid grid-cols-3 gap-2 text-center">
            {[
              ...
              <div key={l} className="rounded-2xl py-3"
                ...
                <div className="neko-text-module-title text-[oklch(0.4_0.1_320)]">{v}</div>
                <div className="mt-0.5 neko-text-tiny text-[oklch(0.55_0.05_300)]">{l}</div>
              </div>
            ))}
          </div>

          {/* quote */}
          <div className="mt-5 rounded-2xl bg-[oklch(0.97_0.025_320)] p-4 text-center neko-text-micro text-foreground">
          ...
          <div className="mt-5 flex items-center justify-between border-t border-[oklch(0.92_0.025_320)] pt-4">
            <div>
              <div className="neko-text-tiny text-[oklch(0.55_0.06_300)]">发现它的灵魂</div>
              <div className="mt-0.5 neko-text-tiny text-[oklch(0.45_0.08_320)]">喵一下 · 读懂它的小世界</div>
            </div>
      ...
      <div className="relative z-10 mt-auto px-6 pb-6">
        <div className="grid grid-cols-4 gap-2.5 text-center neko-text-button text-[oklch(0.5_0.05_300)]">
          {[["💾", "保存"], ["📕", "小红书"], ["💬", "微信"], ["···", "更多"]].map(([i, a]) => (
            <button key={a} className="rounded-2xl bg-white/80 py-3.5 backdrop-blur shadow-[0_6px_16px_-10px_oklch(0.78_0.11_305/0.4)]">
              <div className="neko-text-card-title">{i}</div>
