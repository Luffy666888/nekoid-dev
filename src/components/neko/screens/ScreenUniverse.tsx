  ...
  return (
    <div className="absolute inset-0 flex flex-col pt-[52px] text-foreground overflow-y-auto scrollbar-none"
      ...
      <div className="relative z-10 px-6">
        <div className="neko-text-tiny text-[oklch(0.6_0.08_320)]">PARALLEL UNIVERSE</div>
        <h2 className="mt-2 neko-text-module-title">
          它在另一个<br /><span className="text-soul italic">宇宙</span>里，是谁？
        </h2>
      </div>
      ...
      <div className="relative z-10 mt-4 flex gap-2 overflow-x-auto px-6 pb-2 scrollbar-none">
        {categories.map((c, i) => (
          <span key={c} className={
            "shrink-0 rounded-full px-3.5 py-1.5 neko-text-badge " +
            (i === 0
      ...
      <div className="relative z-10 mx-5 mt-3 overflow-hidden rounded-[28px] bg-white shadow-[0_20px_40px_-20px_oklch(0.78_0.11_305/0.35)]">
        <div className="relative">
          ...
          <div className="absolute right-3 top-3 rounded-full bg-white/85 px-2.5 py-1 neko-text-badge text-[oklch(0.55_0.08_320)] backdrop-blur">
            ✦ AI GENERATED
          </div>
          <div className="absolute left-3 top-3 rounded-full bg-[oklch(0.78_0.11_305)] px-2.5 py-1 neko-text-badge text-white">
            EP · 07
          </div>
        </div>
        <div className="p-4">
          <div className="neko-text-tiny text-[oklch(0.6_0.1_320)]">魔法学院 · 学徒篇</div>
          <div className="mt-1.5 neko-text-body text-foreground">
      ...
      <div className="relative z-10 mx-5 my-5 rounded-[24px] border border-dashed border-[oklch(0.8_0.06_320)] bg-white/50 py-4 text-center neko-text-micro text-[oklch(0.55_0.08_320)]">
        ✦ 继续生成平行宇宙
      </div>
    </div>
  );
  ...
  return (
    <div className="relative overflow-hidden rounded-[22px] bg-white shadow-[0_10px_24px_-14px_oklch(0.78_0.11_305/0.3)]">
      <div className="relative">
        ...
        <span className="absolute left-2 top-2 rounded-full bg-white/85 px-2 py-0.5 neko-text-badge text-[oklch(0.55_0.1_320)] backdrop-blur">{tag}</span>
      </div>
      <div className="p-3">
        <div className="neko-text-micro text-foreground">{title}</div>
        <div className="mt-0.5 neko-text-tiny text-[oklch(0.58_0.04_300)]">{sub}</div>
        <div className="mt-1.5 neko-text-tiny text-[oklch(0.6_0.08_320)]">♡ {likes}</div>
      </div>
    </div>
  );
}
