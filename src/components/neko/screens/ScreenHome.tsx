  ...
  return (
    <div className="absolute inset-0 flex flex-col pt-[58px] overflow-y-auto scrollbar-none"
      ...
      <div className="relative z-10 px-6">
        <div className="neko-text-tiny text-[oklch(0.6_0.05_300)]">2026 · 05 · 27 · 周三</div>
        <h1 className="mt-2 neko-text-module-title text-foreground">
          晚上好，<span>糯米团</span> <span className="neko-text-card-title">🌙</span>
        </h1>
        <p className="mt-1 neko-text-micro text-[oklch(0.58_0.04_300)]">它今天有一点点想你。</p>
      </div>
      ...
      <div className="relative z-10 mx-5 mt-5 overflow-hidden rounded-[32px] glass-tint">
        ...
        <div className="relative flex items-center gap-4 p-5">
          ...
          <div className="flex-1">
            <div className="neko-text-tiny text-[oklch(0.65_0.1_320)]">SOUL · INTP-T</div>
            <div className="mt-1 neko-text-card-title text-foreground">糯米团</div>
            <div className="mt-0.5 neko-text-tiny text-[oklch(0.58_0.04_300)]">3 岁 · 金吉拉 · ♀</div>
            <div className="mt-2 flex items-center gap-1.5">
              <span className="h-1.5 w-1.5 rounded-full bg-[oklch(0.78_0.11_305)] animate-pulse-soft" />
              <span className="neko-text-tiny text-[oklch(0.55_0.06_300)]">同步中 · 87.4%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-5 mt-4 rounded-[28px] p-5 glass">
        <div className="flex items-center justify-between">
          <span className="neko-text-tiny text-[oklch(0.58_0.04_300)]">今日情绪</span>
          <span className="neko-text-tiny text-[oklch(0.65_0.1_320)]">SOFT · DREAMY</span>
        </div>
        <div className="mt-3 flex items-end justify-between">
          <div>
            <div className="neko-text-main-title text-foreground">温柔</div>
            <div className="mt-1 neko-text-tiny text-[oklch(0.58_0.04_300)]">带一点点撒娇</div>
          </div>
      ...
      <div className="relative z-10 mx-5 mt-4 rounded-[28px] p-5"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="neko-text-tiny text-[oklch(0.5_0.06_300)]">AI 观察日记</span>
        </div>
        <p className="mt-3 neko-text-support text-foreground">
          “你回家后，<br />她在门口停留了 <span className="text-[oklch(0.6_0.12_320)]">7 分钟</span>，<br />然后悄悄跟到了沙发边。”
        </p>
        <div className="mt-3 flex items-center justify-between neko-text-tiny text-[oklch(0.55_0.05_300)]">
          <span>— 喵一下 · 19:42</span>
          <span>查看完整观察 →</span>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-5 mt-5 mb-5">
        <button className="flex w-full items-center justify-between rounded-full px-6 py-4 neko-text-button text-white shadow-[0_12px_30px_-12px_oklch(0.78_0.11_305/0.6)]"
      ...
      <div className="relative z-10 mt-auto mx-5 mb-4 flex items-center justify-around rounded-full bg-white/80 px-3 py-3 shadow-[0_-4px_20px_-10px_oklch(0.78_0.11_305/0.25)] backdrop-blur">
        {[
          ...
          <span key={t.l} className={"neko-text-tiny " + (t.a ? "rounded-full bg-[oklch(0.95_0.04_320)] px-4 py-1.5 text-[oklch(0.5_0.1_320)]" : "text-[oklch(0.6_0.04_300)]")}>{t.l}</span>
        ))}
      </div>
    </div>
  );
...
function MiniCard({ hint, title, tag, tone }: { hint: string; title: string; tag: string; tone?: boolean }) {
  return (
    <div className="rounded-[24px] p-4 glass"
      ...
      <div className="flex items-center justify-between">
        <span className="neko-text-tiny text-[oklch(0.58_0.04_300)]">{hint}</span>
        <span className="neko-text-support">{tag}</span>
      </div>
      <div className="mt-2 neko-text-caption text-foreground">{title}</div>
    </div>
  );
}
